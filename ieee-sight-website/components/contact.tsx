      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Ready to join our mission or collaborate on humanitarian technology projects? We'd love to hear from you.
          </p>
        </div>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+91 79 4032 4032</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">ieee.sight@sou.edu.in</p>
                  </div>
                </div>
